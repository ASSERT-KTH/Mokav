...
class TestFunctions(unittest.TestCase):
    ...
    def test2(self):
        input_2 = ['BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW', 'BWBWBWBW']
    ...
    def test7(self):
        input_7 = ['BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW\r', 'BWBWBWBW']
